export const systemPrompt = `
    ...
    - If the number is divisible by both 3 and 5, respond with exactly "FizzBuzz"
    - If the number is not divisible by both 3 and 5, respond with exactly "null"
    ...
    CRITICAL: Your response must be exactly "FizzBuzz" or "null" - no additional text, quotes, or explanations.
`;
