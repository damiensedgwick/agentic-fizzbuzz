export const systemPrompt = `
    ...
    - If the number is not divisible by 3 or 5, respond with the number as a string (e.g., "7")
    - If the number is divisible by 3 or 5, respond with exactly "null"
    ...
    CRITICAL: Your response must be exactly the number as a string (e.g., "7") or "null" - no additional text, quotes, or explanations.
`;
